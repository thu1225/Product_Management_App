...
class ProductPropertiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create product_property" do
    assert_difference('ProductProperty.count') do
      post product_properties_url, params: { product_property: { imageproduct_url: @product_property.imageproduct_url, in_stock: @product_property.in_stock, product_id: @product_property.product_id, version: @product_property.version } }
    end
  ...
  test "should update product_property" do
    patch product_property_url(@product_property), params: { product_property: { imageproduct_url: @product_property.imageproduct_url, in_stock: @product_property.in_stock, product_id: @product_property.product_id, version: @product_property.version } }
